...
class DogRepository {
    ...
    suspend fun getDogsCollections(): ApiResponseStatus<List<DogModel>> {
        return withContext(Dispatchers.IO){
            ...
            if (allDogsListResponse is ApiResponseStatus.Error){
                ...
                ApiResponseStatus.Success(getCollectionsList(allDogsListResponse.data, userDogsListResponse.data))
            } else {
    ...
    suspend fun getUserDogs(): ApiResponseStatus<List<DogModel>> {
        return makeNetworkCall {
